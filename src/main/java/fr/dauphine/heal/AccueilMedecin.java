...
@WebServlet( name = "accueilMedecinServlet", value = "/accueil-medecin" )
public class AccueilMedecin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("accueil-medecin.jsp");
        UserBo userBo = (UserBo) req.getSession().getAttribute("user");
        if (userBo != null && userBo.getType().equals("medecin") && userBo.getStatut().equals("actif")) {
